...
const countNumberOfChildren = (arr) => {
  ...
  let mapped = filtered.map((v, i) => {
    return v.children.length;
  });

  // console.log(mapped);
  return mapped.reduce(function (accumulator, value, idx) {
...
const countPrimeNumbers = (arr) => {
  ...
  // I feel silly.. I spent too much time on this because I thought 1 was a prime number! :( so after repeated outputs of what I thought was the wrong answer, I went and googled and was overcome with shame. FOR SHAME!
};

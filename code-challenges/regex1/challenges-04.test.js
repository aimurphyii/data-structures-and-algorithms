...
const citiesAtoJ = (arr) => {
  ...
  // console.log(arr);
  let cities = str.replace(/\s[A-Z]/g,'_');
  let space = cities.replace(/,/g,' ');
  // console.log(space);
  // console.log(space.match(/[A-J]\w+/g));
  return space.match(/[A-J]\w+/g);
...
const matchMonth = (input) => {
  // Solution code here...
  let reg = /^october|^October|Oct\b|oct\b/;
  return reg.test(input);
  // if (input == reg){
  //   console.log('true ', input, reg);
  //   return true;
  // }else{
  //   console.log('false, ', input, reg);
  //   return false;
  // }
};
...
const noPunctuation = str => {
  // Solution code here...
  let words = str.match(/[a-z]\s|[a-z]\w+\s/ig);
  return words;
